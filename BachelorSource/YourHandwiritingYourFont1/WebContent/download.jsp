...
<ul id ="menu">
	...
	<li><a class="skel-panels-ignoreHref" onclick="Who()"><span class="fa fa-user">Contributers</span></a></li></ul>
</nav>
</div>
</div>
...
<div class="container">
<div class="note">
<p>In Fontifi, we are humanizing the writing of text in the digital world.
Instead of the system supplied designer fonts, we are enabling the user 
to use his own handwriting. We believe that this is one way we can
regain the lost subjectivity by an impersonal and
often cold technology. Our moto is: be yourself and improve on that.</p>
</div>
</div>
</section>
</div>
