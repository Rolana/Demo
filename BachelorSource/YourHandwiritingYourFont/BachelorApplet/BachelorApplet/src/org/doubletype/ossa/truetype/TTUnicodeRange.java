...
public class TTUnicodeRange implements Comparable {
	...
	static private ArrayList<TTUnicodeRange> s_list = new ArrayList<TTUnicodeRange>();
	...
	static public TTUnicodeRange of(long a_unicode) {
		...
		UnicodeBlock block = UCharacter.UnicodeBlock.of((int) a_unicode);
		if (block == null)
			return retval;
	...
	static private void initList() {
		...
		s_list.add(new TTUnicodeRange(
					UnicodeBlock.BASIC_LATIN, 0x0020, 0x007a, 0, 63));
		s_list.add(new TTUnicodeRange(
